...
MODULES += ncfm.o unpack_module.o adc_module.o bsc_module.o pwb_module.o Alpha16.o feam_module.o TsSync.o Feam.o Tdc.o FeamEVB.o FeamAsm.o PwbAsm.o AgEvent.o AgEVB.o TrgAsm.o Unpack.o AgAsm.o wfsuppress.o wfsuppress2.o wfsuppress_pwb.o wfsuppress_adc.o wfexport_module.o final_module.o coinc_module.o
